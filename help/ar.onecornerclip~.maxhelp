...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.5, 358.0, 101.0, 22.0 ],
									"text" : "ar.onecornerclip~"
								}
...
, 							{
								"box" : 								{
									...
									"rendermode" : 0,
									"url" : "https://www.airwindows.com/onecornerclip"
								}
