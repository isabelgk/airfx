...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.5, 358.0, 96.0, 22.0 ],
									"text" : "ar.buttercomp2~"
								}
...
, 							{
								"box" : 								{
									"args" : [ "@module", 0, "@loop", 1, "@file", "jongly.aif" ],
									"bgmode" : 0,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "ar.buttercomp2~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 16.0, 13.0, 535.0, 106.0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 16.0, 13.0, 529.0, 101.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : ";\rmax launchbrowser https://www.airwindows.com/buttercomp2/"
								}
