...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.5, 358.0, 116.0, 22.0 ],
									"text" : "ar.compresaturator~"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "ar.compresaturator~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"text" : ";\r\nmax launchbrowser https://www.airwindows.com/compresaturator/"
								}
