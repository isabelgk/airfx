...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.5, 358.0, 118.0, 22.0 ],
									"text" : "ar.brightambience2~"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "ar.brightambience2~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"text" : ";\r\nmax launchbrowser https://www.airwindows.com/brightambience2/"
								}
