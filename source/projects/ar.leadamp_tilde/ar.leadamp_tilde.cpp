...
class leadamp : public object<leadamp>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"LeadAmp is an amp sim with a clear, penetrating, vocal tone."};
