...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "Pos Thr", 0.966, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "Neg Thr", 0.966, range {0.0, 1.0} };
