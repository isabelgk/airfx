...
class tube2 : public object<tube2>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"Tube2 extends Tube, with more sophisticated processing and input trim."};
	MIN_TAGS {"analog, tube"};
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "tube", 0.5, range {0.0, 1.0} };
