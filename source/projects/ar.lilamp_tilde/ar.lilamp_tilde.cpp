...
class lilamp : public object<lilamp>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"LilAmp is a tiny amp sim, like a little bitty practice amp without that much gain."};
	MIN_TAGS {"analog, amp, modeling"};
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "tone", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "output", 0.8, range {0.0, 1.0} };
	...
	void operator()(audio_bundle _input, audio_bundle _output) {
		...
		double cutoff = (15000.0+(B*10000.0)) / samplerate();
