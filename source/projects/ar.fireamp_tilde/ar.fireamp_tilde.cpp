...
class fireamp : public object<fireamp>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"FireAmp is a bright, loud, tubey amp sim for leads and dirt guitar."};
