...
class nonlinearspace : public object<nonlinearspace>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"a flexible reverb"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "SmpRate", 0.3, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "Livenes", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "Treble", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "Bass", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> E {this, "Nonlin", 0.5, range {0.0, 1.0} };
