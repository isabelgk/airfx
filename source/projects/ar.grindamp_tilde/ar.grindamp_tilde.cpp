...
class grindamp : public object<grindamp>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"GrindAmp is a heavier amp sim for many purposes."};
	...
	void operator()(audio_bundle _input, audio_bundle _output) {
		...
		double cutoff = (18000.0+(B*1000.0)) / samplerate();
