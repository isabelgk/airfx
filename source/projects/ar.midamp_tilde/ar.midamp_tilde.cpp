...
class midamp : public object<midamp>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"MidAmp is a clean amp sim meant to work like a loud Twin or something of that nature."};
