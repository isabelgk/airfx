...
class ncseventeen : public object<ncseventeen>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"dirty loud"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "LOUDER", 0.0, range {0.0, 1.0} };
