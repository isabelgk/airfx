...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "Damping", 0.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "Speed", 0.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "Vibrato", 0.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> E {this, "RmSize", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> F {this, "Flavor", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> G {this, "Dry/Wet", 1.0, range {0.0, 1.0} };
