...
class noise : public object<noise>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"the Airwindows deep noise oscillator as a sound reinforcer"};
	MIN_TAGS {""};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "highcut", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "lowcut", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "shape", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "decay", 1.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> E {this, "distinctness", 0.0, range {0.0, 1.0} };
