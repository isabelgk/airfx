...
class neverland : public object<neverland>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"Neve-style color adder"};
	MIN_TAGS {"character"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "hardness", 0.74, range {0.0, 1.0} };
