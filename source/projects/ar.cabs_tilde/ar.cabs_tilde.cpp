...
class cabs : public object<cabs>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"Cabs is an Airwindows guitar speaker cabinet simulator."};
	MIN_TAGS {"amp, modeling, cabinet"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "cabtype", 0.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "intense", 0.66, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "rmloud", 0.33, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "cabsize", 0.66, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> E {this, "offaxis", 0.33, range {0.0, 1.0} };
