...
class monitoring2 : public object<monitoring2>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"Monitoring2 is Monitoring, but with Dark as the wordlength reducer"};
	MIN_TAGS {"monitoring"};
