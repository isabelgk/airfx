...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "Mid HiPass", 0.203419, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "Side HiPass", 0.3424051, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "H Limit", 0.32, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "Groove Wear", 0.064, range {0.0, 1.0} };
