...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "midhighpass", 0.203419, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "sidehighpass", 0.3424051, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "highlimit", 0.32, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "groovewear", 0.064, range {0.0, 1.0} };
