...
class monitoring3 : public object<monitoring3>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"Monitoring3 is Monitoring, but with Ten Nines into Dark as the wordlength reducer"};
	MIN_TAGS {"monitoring"};
	...
	attribute<int, threadsafe::no, limit::clamp> A {this, "monitor", 0, range {0, 16}, description {
		"0 = Out24, 1 = Out16, 2 = Peaks, 3 = Slew, 4 = Subs, 5 = Mono, 6 = Side, 7 = Vinyl, 8 = Aurat, 9 = MonoRat, 10 = MonoLat, 11 = Phone, 12 = Cans A, 13 = Cans B, 14 = Cans C, 15 = Cans D, 16 = V Trick"} };
