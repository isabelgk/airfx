...
class melt : public object<melt>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"a wobbly chorusy weird diffuse effect"};
	MIN_TAGS {"chorus"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "depth", 0.25, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "range", 0.75, range {0.0, 1.0} };
