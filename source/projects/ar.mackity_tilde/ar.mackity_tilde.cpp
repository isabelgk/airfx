...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "In Trim", 0.1, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "Out Pad", 1.0, range {0.0, 1.0} };
