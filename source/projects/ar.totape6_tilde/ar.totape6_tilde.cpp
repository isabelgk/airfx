...
public:
    ...
    attribute<number, threadsafe::no, limit::clamp> A { this, "Input", 0.0, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> B { this, "Soften", 0.0, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> C { this, "Head B", 0.0, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> D { this, "Flutter", 0.0, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> E { this, "Output", 0.0, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> F { this, "Dry/Wet", 0.0, range {0.0, 1.0} };
