...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "LTarget", 0.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "BtDepth", 0.0, range {0.0, 1.0} };
