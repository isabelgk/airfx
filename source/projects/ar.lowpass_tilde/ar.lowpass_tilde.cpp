...
class lowpass : public object<lowpass>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"deepens the tone, leaves a gloss and textural modifications"};
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "Soft/Hard", 0.5, range {0.0, 1.0} };
