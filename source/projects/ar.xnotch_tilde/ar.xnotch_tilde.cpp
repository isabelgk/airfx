...
class xnotch : public object<xnotch>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"distorted digital EQ, not as glitchy as the others"};
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "Freq", 1.0, range {0.0, 1.0} };
	...
	void operator()(audio_bundle _input, audio_bundle _output) {
		...
		biquadA[0] = (pow(B,3)*20000.0)/samplerate();
