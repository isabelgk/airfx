...
class swell : public object<swell>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"adds attack"};
	MIN_TAGS {""};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "threshold", 0.9, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "swell", 0.5, range {0.0, 1.0} };
