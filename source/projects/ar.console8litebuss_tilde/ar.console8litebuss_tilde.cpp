...
class console8litebuss : public object<console8litebuss>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"Console8LiteBuss is simplified Console8, working with just a single mix buss."};
	MIN_TAGS {"analog"};
