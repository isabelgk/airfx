...
public:
    ...
    attribute<number, threadsafe::no, limit::clamp> A { this, "22K tap", 0.5, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> B { this, "15K tap", 0.5, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> C { this, "11K tap", 0.5, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> D { this, "filters Q", 0.0, range {0.0, 1.0} };
    attribute<number, threadsafe::no, limit::clamp> E { this, "Output Level", 1.0, range {0.0, 1.0} };
