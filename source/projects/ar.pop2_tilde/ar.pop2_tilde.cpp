...
public:
	MIN_DESCRIPTION {"Pop2 adds control and punch to Pop."};
	MIN_TAGS {"compressor"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "compress", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> B {this, "attack", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "release", 0.5, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> D {this, "drive", 0.5, range {0.0, 1.0} };
