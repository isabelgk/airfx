...
class tapefat : public object<tapefat>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"tone control from ar.tapedelay~"};
	...
	attribute<number, threadsafe::no, limit::clamp> A {this, "Lean/Ft", 1.0, range {0.0, 1.0} };
