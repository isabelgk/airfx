...
public:
	...
	attribute<number, threadsafe::no, limit::clamp> B {this, "Output Level", 0.0, range {0.0, 1.0} };
	attribute<number, threadsafe::no, limit::clamp> C {this, "Dry/Wet", 0.0, range {0.0, 1.0} };
